...
VecL = logspace(-3,8,60);              % We define the grid of epsilons.
VecMu = 0;%logspace(-3,8,2);           % For regularization if needed
...
for n=1:Num
    ...
    t0_iter=tic;
    Code_4_fun_Mu_Final(X,y,z,XT,yT,zT,F,VecL,VecMu,strcat(Name,iter))
